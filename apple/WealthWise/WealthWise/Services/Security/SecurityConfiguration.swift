...
/// Security accessibility constants wrapper
public struct SecurityAccessibility {
    // Use only widely available constants from the autocomplete suggestions
    public static let biometricCurrentSet: CFString = kSecAttrAccessibleWhenUnlockedThisDeviceOnly
    
    public static let biometricCurrentSetDevicePasscode: CFString = kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly
    
    public static let biometricCurrentSetApplicationPassword: CFString = kSecAttrAccessibleWhenUnlockedThisDeviceOnly
    
    public static let biometricAny: CFString = kSecAttrAccessibleAfterFirstUnlock
    
    public static let applicationPassword: CFString = kSecAttrAccessibleWhenUnlockedThisDeviceOnly
}
...
public struct SecurityConfiguration: Sendable {
    // Common service identifiers used across Keychain and security services
    public struct ServiceIdentifiers {
        public static let main = "com.wealthwise.app"
        public static let encryption = "com.wealthwise.encryption"
        public static let biometrics = "com.wealthwise.biometrics"
    }
    ...
    /// Biometric prompt allowable reuse duration (alias of biometricTimeout)
    /// Used by `LAContext.touchIDAuthenticationAllowableReuseDuration`
    public static let biometricPromptTimeout: TimeInterval = biometricTimeout
    ...
    /// Generic key derivation iteration defaults (alias of pbkdf2Iterations)
    public static let keyDerivationIterations: Int = pbkdf2Iterations
    ...
    public struct KeyAccessibility: Sendable {
        public static let standard: SecAccessibility = SecurityAccessibility.biometricCurrentSet
        public static let high: SecAccessibility = SecurityAccessibility.biometricCurrentSetDevicePasscode
        public static let quantum: SecAccessibility = SecurityAccessibility.biometricCurrentSetApplicationPassword
        public static let background: SecAccessibility = SecurityAccessibility.biometricAny
        public static let applicationProtected: SecAccessibility = SecurityAccessibility.applicationPassword
    }
    ...
    public struct SecurityLevelRequirements: Sendable {
        ...
        public static let high = SecurityLevelConfig(
            encryption: EncryptionAlgorithm.aes256gcm,
            keyDerivation: KeyDerivationFunction.argon2id,
            biometricRequired: true,
            secureEnclaveRequired: true,
        ...
        public static let quantum = SecurityLevelConfig(
            encryption: EncryptionAlgorithm.postQuantumHybrid,
            keyDerivation: KeyDerivationFunction.argon2id,
            biometricRequired: true,
            secureEnclaveRequired: true,
            postQuantumEnabled: true,
