                ...
                VStack(spacing: 32) {
                    ...
                    Group {
                        ...
                        case .unauthenticated:
                          ...
                          case .authenticating, .biometricRequired, .passcodeRequired:
                            AuthenticatingView()
...
//                    .navigationBarTitleDisplayMode(.inline)
    ...
    private func handleAuthentication(_ method: AuthenticationMethod) async {
        ...
        do {
            ...
            hapticManager.notification(.error)
          authenticationError = error as? AuthenticationError ?? 
            .unknown(error.localizedDescription as! Error)
        }
...
extension BiometricType {
    ...
    var description: String {
        ...
        case .iris:
            return "Authenticate with iris recognition"
        case .windowsHello:
            return "Authenticate with Windows Hello"
        case .windowsFingerprint:
            return "Authenticate with Windows fingerprint"
        case .passkeyBiometric:
            return "Authenticate with passkey biometric"
        }
    }
}
