...
import { BarChart3, DollarSign, PieChart, TrendingDown, TrendingUp } from 'lucide-react';
...
export function BrokerageView({ account, brokerageDetails }: BrokerageViewProps) {
      ...
      <div className="brokerage-view">
        <Card>
          <div className="brokerage-view__empty">
            ...
            <p>Add brokerage details to track your investments, holdings, and returns.</p>
          </div>
        </Card>
      </div>
    );
    ...
    <div className="brokerage-view">
      ...
      <div className="brokerage-view__header">
        ...
        {brokerageDetails.broker_name && (
          <span className="brokerage-view__broker">{brokerageDetails.broker_name}</span>
        )}
      </div>

      {/* Portfolio Value Card */}
      <Card className={`brokerage-view__portfolio-card brokerage-view__portfolio-card--${returnsColor}`}>
        <div className="brokerage-view__portfolio-header">
          <div>
            ...
            <div className="brokerage-view__portfolio-returns">
              ...
              <span>
                {brokerageDetails.total_returns >= 0 ? '+' : ''}
                {formatCurrency(brokerageDetails.total_returns, account.currency)}
              </span>
      ...
      <div className="brokerage-view__stats">
        <StatCard
          ...
          value={formatCurrency(brokerageDetails.invested_value, account.currency)}
          icon={<DollarSign size={20} />}
        />
        
        <StatCard
          label="Realized Gains"
          value={formatCurrency(brokerageDetails.realized_gains, account.currency)}
        ...
        <div className="brokerage-view__holdings">
          <div className="brokerage-view__holding-item">
            <div className="brokerage-view__holding-info">
              <div className="brokerage-view__holding-icon brokerage-view__holding-icon--equity">📈</div>
              <div>
                <span className="brokerage-view__holding-label">Equity</span>
                <span className="brokerage-view__holding-sublabel">Stocks & Shares</span>
              </div>
            </div>
            <span className="brokerage-view__holding-count">
              {brokerageDetails.equity_holdings} {brokerageDetails.equity_holdings === 1 ? 'holding' : 'holdings'}
            </span>
          </div>

          <div className="brokerage-view__holding-item">
            <div className="brokerage-view__holding-info">
              <div className="brokerage-view__holding-icon brokerage-view__holding-icon--mf">📊</div>
              <div>
                <span className="brokerage-view__holding-label">Mutual Funds</span>
                <span className="brokerage-view__holding-sublabel">Managed Investments</span>
              </div>
            </div>
            <span className="brokerage-view__holding-count">
              {brokerageDetails.mutual_fund_holdings} {brokerageDetails.mutual_fund_holdings === 1 ? 'fund' : 'funds'}
            </span>
          </div>

          <div className="brokerage-view__holding-item">
            <div className="brokerage-view__holding-info">
              <div className="brokerage-view__holding-icon brokerage-view__holding-icon--bond">🏦</div>
              <div>
                <span className="brokerage-view__holding-label">Bonds</span>
                <span className="brokerage-view__holding-sublabel">Fixed Income</span>
              </div>
            </div>
            <span className="brokerage-view__holding-count">
              {brokerageDetails.bond_holdings} {brokerageDetails.bond_holdings === 1 ? 'bond' : 'bonds'}
            </span>
          </div>

          <div className="brokerage-view__holding-item">
            <div className="brokerage-view__holding-info">
              <div className="brokerage-view__holding-icon brokerage-view__holding-icon--etf">💼</div>
              <div>
                <span className="brokerage-view__holding-label">ETFs</span>
                <span className="brokerage-view__holding-sublabel">Exchange Traded Funds</span>
              </div>
            </div>
            <span className="brokerage-view__holding-count">
              {brokerageDetails.etf_holdings} {brokerageDetails.etf_holdings === 1 ? 'ETF' : 'ETFs'}
            </span>
          </div>
        </div>
      </Card>
        ...
        <div className="brokerage-view__details">
          ...
          {brokerageDetails.account_type && (
            <div className="brokerage-view__detail-row">
              ...
              <span className="brokerage-view__detail-value">
                {brokerageDetails.account_type.charAt(0).toUpperCase() + brokerageDetails.account_type.slice(1)}
              </span>
            </div>
          )}
          ...
          <div className="brokerage-view__detail-row">
            <span>Status</span>
            <span className={`brokerage-view__detail-badge brokerage-view__detail-badge--${brokerageDetails.status}`}>
              {brokerageDetails.status.charAt(0).toUpperCase() + brokerageDetails.status.slice(1)}
            </span>
          </div>
        </div>
      </Card>
      ...
      <Card>
        ...
        <div className="brokerage-view__settings">
          <div className={`brokerage-view__setting ${brokerageDetails.auto_square_off ? 'brokerage-view__setting--active' : ''}`}>
            <div className="brokerage-view__setting-icon">
              {brokerageDetails.auto_square_off ? '✅' : '❌'}
            </div>
            <div>
              <span className="brokerage-view__setting-label">Auto Square Off</span>
          ...
          <div className={`brokerage-view__setting ${brokerageDetails.margin_enabled ? 'brokerage-view__setting--active' : ''}`}>
            <div className="brokerage-view__setting-icon">
              {brokerageDetails.margin_enabled ? '✅' : '❌'}
            </div>
            <div>
              <span className="brokerage-view__setting-label">Margin Trading</span>
              <span className="brokerage-view__setting-sublabel">
