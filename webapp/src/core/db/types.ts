...
export type AccountType = 'bank' | 'credit_card' | 'upi' | 'brokerage' | 'cash' | 'wallet'
 ...
 */
export type CreateAccountInput = Omit<Account, 'id' | 'created_at' | 'updated_at' | 'balance'> & {
  balance?: number
}
...
export type CreateBudgetInput = Omit<Budget, 'id' | 'created_at' | 'updated_at' | 'spent'> & {
  spent?: number
}

export type CreateGoalInput = Omit<Goal, 'id' | 'created_at' | 'updated_at' | 'current_amount'> & {
  current_amount?: number
}
