...
import type { CreateGoalInput, Goal, GoalStatus, UpdateGoalInput } from '@/core/db'
...
export const useGoalStore = create<GoalState>((set, get) => ({
  ...
  contributeToGoal: async (_goalId, _amount, _note) => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Failed to contribute to goal'
      set({ error: errorMessage, isLoading: false })
      return false
    }
  },
