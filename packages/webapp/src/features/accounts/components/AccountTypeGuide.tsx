...
const ACCOUNT_TYPES: AccountTypeInfo[] = [
  ...
  },
  {
    ...
    title: 'Fixed Deposit',
    description: 'Term deposits with fixed interest',
    examples: ['SBI FD', 'HDFC Fixed Deposit', 'ICICI FD'],
    recommended: true,
  },
  {
    ...
    description: 'Monthly deposit schemes',
    examples: ['SBI RD', 'Post Office RD', 'Bank RD'],
  },
  {
    type: 'ppf',
    icon: <Lock size={32} />,
    ...
    examples: ['SBI PPF', 'Bank PPF', 'Post Office PPF'],
  },
  {
    type: 'nsc',
    icon: <Scroll size={32} />,
    ...
    examples: ['Post Office NSC', 'NSC VIII Issue'],
  },
  {
    type: 'scss',
    icon: <Shield size={32} />,
    ...
    examples: ['Post Office SCSS', 'Bank SCSS'],
  },
  {
    type: 'credit_card',
